...
\item Chọn $t_1 = 1 $ suy ra cơ sở mới:
...
\item Ta có: $\|x_1\|= \sqrt{4442}$ và $\|x_2\| = \sqrt{157}$ $\Rightarrow$ $\|x_1\| \geq \|x_2\|$, hoán vị 2 vector ta có:
$$\begin{cases}
x_1 = (6, 11)\\
x_2 = (31, 59)
\end{cases}  $$
...
\item Và: $\dfracdfrac{x_1^{'}.x_2^{'}}{x_1^{'}.x_1^{'}} \approx 5, 3$
\item Chọn $t_1 = 1 $ suy ra cơ sở mới:
