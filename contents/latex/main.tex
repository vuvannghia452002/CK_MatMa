...
% Nếu $x_1, x_2, ..., x_n$ là một cơ sở $\alpha$-rút gọn của lưới $L$ trong $R^n$ 
% và $x_1^*, x_2^*, ..., x_n^*$ là cơ sở trực giao hóa Gram-Schmidt của nó thì 
...
% \|x_1\|.\|x_2\|...\|x_n\| \leq \beta^{\tfrac{n(n-1)}{4}}det(L)
% \end{equation}
