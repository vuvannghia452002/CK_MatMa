...
\item Rút gọn cơ sở có thể được sử dụng để giải bài toán vector ngắn nhất theo nghĩa là vector cơ sở ngắn nhất

\begin{figure}[H]
\centering
\includegraphics[scale = 0.15]{pictures/mo_ta_ket_qua_giam_luoi_LLL.png}
