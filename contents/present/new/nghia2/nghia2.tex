...
%     \begin{frame}
%     \frametitle{Phương Trình Cần Giải Quyết}
%     \begin{block}{Phương trình}
%     \[
%     64784502 = (5180 + x)^3 \mod 115348777
%     \]
%     \end{block}
%     \begin{block}{Khai triển và đơn giản hóa}
%     \[
...
%         \[
%         \mathbf{b}_1 = (115348777, 0, 0, 0)
%         \]
%         \[
%         \mathbf{b}_2 = (0, 1038138993, 0, 0)
%         \]
%         \[
%         \mathbf{b}_3 = (0, 0, 9343250937, 0)
%         \]
%         \[
%         \mathbf{b}_4 = (47119990, 724474800, 1258740, 0)
%         \]
%     \end{itemize}
%     \end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     \frametitle{Giải SVP}
%     \begin{itemize}
%         \item Áp dụng thuật toán LLL để giải bài toán SVP.
%         \item Kết quả cơ sở vector:
%         \[
%         \mathbf{v}_1 = (13942760, -14799933, -3334365, 2630232)
%         \]
...
%         \item Do $0 \leq x \leq 9$, ta chọn $x = 8$ là nghiệm khả dĩ.
%     \end{itemize}
%     \end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    
%     % Slide 5: Ghi chú và quan sát
%     \begin{frame}
%     \frametitle{Ghi Chú và Quan Sát}
%     \begin{itemize}
%         \item $\mathbf{v}_1$ là nghiệm xấp xỉ của SVP, cần xác minh nghiệm.
%         \item Kiểm tra lại: $(5180+8)^3 \mod 115348777 = 64784502$, do đó $x = 8$ là nghiệm đúng.
%         \item Khi giải phương trình bậc ba, có thể nghiệm không phải là số nguyên, sử dụng giá trị làm tròn để tìm nghiệm khả dĩ.
%         \item Số mũ $e$ tương ứng với số vector cơ sở của lưới, phương pháp này áp dụng được khi $e < 100$.
%     \end{itemize}
%     \end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
